...
start "Node Server 1" cmd /k "pushd E:\Interview-Question-SDE-main && node server.js"
...
start "Node Server 2" cmd /k "pushd E:\Interview-Question-SDE-main\studycode && npm start"
